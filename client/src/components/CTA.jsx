...
const CTA = () => {
  return (
    <section className="py-12">
      <div className="max-w-5xl mx-4 md:mx-auto p-px rounded-2xl bg-gradient-to-r from-purple-600/20 to-blue-500/30">
        <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#F3EAFF] to-[#E1EFFF] px-6">
          
          {/* Badge */}
          <div className="flex items-center justify-center bg-white px-3 py-1.5 shadow-sm gap-2 rounded-full text-xs mb-4">
            ...
            <span className="bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent font-semibold tracking-tight">Trusted by Millions</span>
          </div>

          {/* Headline */}
          <h2 className="text-3xl md:text-5xl font-bold mt-2 leading-[1.15] tracking-tight text-slate-900">
          ...
          <p className="text-slate-600 mt-4 max-w-xl text-lg leading-relaxed">
            We are the leading media marketplace that connects brands with their customers with user-friendly interface.
          </p>

          {/* Action Button */}
          <button 
            type="button" 
            className="mt-8 bg-gradient-to-r from-purple-600 to-blue-500 text-white px-8 py-3.5 rounded-xl font-semibold shadow-lg shadow-purple-200 hover:shadow-purple-300 hover:scale-[1.02] active:scale-95 transition-all duration-200"
          > 
            Get Started Today
          </button>
        </div>
