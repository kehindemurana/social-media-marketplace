...
const AllListings = () => {
  ...
  return loading ? (
    ...
    <div>
      ...
      <div
        className="mt-10 overflow-x-auto bg-white
             border border-gray-200 w-full max-w-5xl rounded-xl"
      >
                    ...
                    return (
                      <button
                        className={`flex items-center gap-1
                         px-2 text-xs py-0.5 rounded-full ${color.bg}
                                              ${color.text}`}
                      >
                        <color.icon size={12} />
                    ...
                    {listing.status !== "deleted" ? (
                      <select
                        ...
                        className="px-2 py-1.5 mt-1 text-gray-500 border
                         border-gray-300 rounded-md outline-none"
                      >
