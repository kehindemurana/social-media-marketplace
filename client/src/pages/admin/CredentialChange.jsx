    ...
    return loading ? (
        ...
        <div className='h-full'>
            {listings.length === 0 ? (
                ...
                text-center text-gray-600 h-full'>
                ...
                <>
                    ...
                    <div className='mt-10 overflow-x-auto bg-white border
                     border-gray-200 w-full max-w-4xl rounded-xl'>
                        <table className='w-full text-sm text-left 
                         text-gray-700  '>
                            <thead className='text-xs uppercase border-b
                             border-gray-200'>
                                <tr>
                                    <th className='pl-4 py-1'> # </th>
